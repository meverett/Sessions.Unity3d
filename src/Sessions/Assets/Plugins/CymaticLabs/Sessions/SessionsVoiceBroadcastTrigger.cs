...
namespace Dissonance
{
    ...
    public class SessionsVoiceBroadcastTrigger
        : BaseCommsTrigger, IVoiceActivationListener
    {
        ...
        // Whether or not push-to-talk is presently active
        private bool _pushToTalkActive = false;
        ...
        private bool IsUserActivated()
        {
            ...
            switch (Mode)
            {
                ...
                case CommActivationMode.PushToTalk:
                    return _pushToTalkActive || (!string.IsNullOrEmpty(InputName) && Input.GetAxis(InputName) > 0.5f);
