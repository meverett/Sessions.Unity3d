...
{
    [CustomEditor(typeof(SessionsVoiceBroadcastTrigger))]
    public class SessionsBroadcastTriggerEditor : UnityEditor.Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            var transmitter = (SessionsVoiceBroadcastTrigger)target;
        ...
        private static void FoldoutBoxGroup(ref bool expanded, string title, Action<SessionsVoiceBroadcastTrigger> gui, SessionsVoiceBroadcastTrigger trigger)
        {
        ...
        private void ChannelTypeGui([NotNull] SessionsVoiceBroadcastTrigger transmitter)
        {
        ...
        private static void MetadataGUI([NotNull] SessionsVoiceBroadcastTrigger transmitter)
        {
            transmitter.ChangeWithUndo(
        ...
        private static void ActivationModeGui([NotNull] SessionsVoiceBroadcastTrigger transmitter)
        {
            transmitter.ChangeWithUndo(
        ...
        private static void VolumeTriggerActivationGui([NotNull] SessionsVoiceBroadcastTrigger transmitter)
        {
        ...
        private void TokenGui([NotNull] SessionsVoiceBroadcastTrigger transmitter)
        {
            _tokenEditor.DrawInspectorGui(transmitter, transmitter);
        }

        private static void VolumeGui([NotNull] SessionsVoiceBroadcastTrigger transmitter)
        {
        ...
        private static void SingleFaderGui([NotNull] SessionsVoiceBroadcastTrigger transmitter, [NotNull] VolumeFaderSettings settings)
        {
            transmitter.ChangeWithUndo(
