...
namespace Dissonance.Audio.Capture
{
        ...
        : IAmplitudeProvider, ILossEstimator
    {
        ...
        private static bool IsMobilePlatform()
        {
                ...
                return false;
            #elif UNITY_ANDROID || UNITY_IOS || UNITY_IPHONE || UNITY_BLACKBERRY || UNITY_WP8 || UNITY_WII || UNITY_TVOS || UNITY_TIZEN || UNITY_WEBGL
                ...
                // - We have no idea what webGL is running on (and the runtime check probably won't help_, so we've got assume it's mobile
                return true;
